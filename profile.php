...
<div class="row justify-content-center pt-5 mb-5">
  ...
  if (isset($_GET['error'])) {
    ...
    echo "<h4 class='text-center'>$_GET[success]</h4>";
  } else {
    echo '<h4 class="text-center">Заполните форму регистрации</h4>';
  }
  ?>
  <form action="changeProf.php" method="post" class="col-4 row needs-validation
  <?php echo isset($_GET['error']) ? 'was-validated' : ''; ?>" novalidate>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="tel" name="phone" id="phone" class="form-control" value="<?= $_SESSION['phone'] ?>" required>
    </div>
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-primary col-auto mx-auto">Сохранить изменения </button>
  </form>
</div>
